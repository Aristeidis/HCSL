...
Analytical quality control in laboratory medicine.
...
1993: Introduced a genetic algorithms (GAs) based approach to the design of statistical quality control (QC) procedures, representing the first application of evolutionary computation to QC (see HCSL Publications on GAs based QC).
...
2020: Developed a software tool for exploring the relation between diagnostic accuracy and measurement uncertainty (see HCSL Publications on Diagnostic Accuracy).
